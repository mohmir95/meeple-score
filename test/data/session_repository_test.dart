...
void main() {
  ...
  test(
    'shared preferences repository stores sessions, roster, and active game',
    () async {
      ...
      await repository.saveRoster(GreatWesternTrailGame.idValue, const [
        player,
      ]);
      ...
      expect(
        await repository.loadActiveGameId(),
        GreatWesternTrailGame.idValue,
      );
      expect(await repository.loadRoster(GreatWesternTrailGame.idValue), [
        player,
      ]);
