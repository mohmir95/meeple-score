...
import 'gwt_setup.dart';
import 'gwt_sheet.dart';
import 'gwt_state.dart';

class GreatWesternTrailGame extends BoardGame {
  ...
  String get description =>
      ...
      'market fills, everyone scores the same categories as the official First '
      'Edition pad.';
  ...
  GameState createInitialState({
    ...
    return GwtState(
      ...
      lines: {
        for (final player in players) player.id: const GwtPlayerLine(),
      },
    );
  }
